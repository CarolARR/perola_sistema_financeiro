...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { CNAE: @fornecedor.CNAE, CNPJ: @fornecedor.CNPJ, inscricaoEstadual: @fornecedor.inscricaoEstadual, nomeFantasia: @fornecedor.nomeFantasia, ramoAtividade: @fornecedor.ramoAtividade, razaoSocial: @fornecedor.razaoSocial } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { CNAE: @fornecedor.CNAE, CNPJ: @fornecedor.CNPJ, inscricaoEstadual: @fornecedor.inscricaoEstadual, nomeFantasia: @fornecedor.nomeFantasia, ramoAtividade: @fornecedor.ramoAtividade, razaoSocial: @fornecedor.razaoSocial } }
